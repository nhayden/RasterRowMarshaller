...
${OBJECTDIR}/RasterRow.o: RasterRow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RasterRow.o RasterRow.cpp

${OBJECTDIR}/RasterRowFiddling.o: RasterRowFiddling.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RasterRowFiddling.o RasterRowFiddling.cpp
...
${TESTDIR}/tests/IntegrationTest.o: tests/IntegrationTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/IntegrationTest.o tests/IntegrationTest.cpp


${TESTDIR}/tests/integration_test_runner.o: tests/integration_test_runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/integration_test_runner.o tests/integration_test_runner.cpp


${TESTDIR}/tests/ArrayWrapperTest.o: tests/ArrayWrapperTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ArrayWrapperTest.o tests/ArrayWrapperTest.cpp


${TESTDIR}/tests/array_wrapper_test_runner.o: tests/array_wrapper_test_runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/array_wrapper_test_runner.o tests/array_wrapper_test_runner.cpp


${TESTDIR}/tests/CompressTest.o: tests/CompressTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CompressTest.o tests/CompressTest.cpp


${TESTDIR}/tests/compression_test_runner.o: tests/compression_test_runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/compression_test_runner.o tests/compression_test_runner.cpp


${TESTDIR}/tests/RasterRowTest.o: tests/RasterRowTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RasterRowTest.o tests/RasterRowTest.cpp


${TESTDIR}/tests/raster_row_test_runner.o: tests/raster_row_test_runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/raster_row_test_runner.o tests/raster_row_test_runner.cpp
...
${OBJECTDIR}/RasterRow_nomain.o: ${OBJECTDIR}/RasterRow.o RasterRow.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RasterRow_nomain.o RasterRow.cpp;\
	else  \
...
${OBJECTDIR}/RasterRowFiddling_nomain.o: ${OBJECTDIR}/RasterRowFiddling.o RasterRowFiddling.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RasterRowFiddling_nomain.o RasterRowFiddling.cpp;\
	else  \
